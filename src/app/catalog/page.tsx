...
const GLOSSAIRE = [
  ...
  { id: "g04", terme: "Golden Record",  domaine: "Clients",     definition: "Version unique et certifiée d'un enregistrement client, résultant de la fusion et déduplication de toutes les sources.", source: "MDM",        phase_intro: 4, certified: true,  owner: "Data Owner Clients",   bcbs: false },
  { id: "g05", terme: "Data Lineage",   domaine: "Gouvernance", definition: "Traçabilité complète du cycle de vie d'une donnée : origine, transformations successives, destinations et consommateurs.", source: "DAMA",       phase_intro: 2, certified: true,  owner: "CDO",                  bcbs: true  },
  { id: "g06", terme: "Data Steward",   domaine: "Gouvernance", definition: "Responsable opérationnel de la qualité et de la documentation d'un domaine de données au quotidien.", source: "DAMA-DMBOK", phase_intro: 2, certified: true,  owner: "CDO",                  bcbs: false },
  { id: "g07", terme: "COREP",          domaine: "Conformité",  definition: "Common Reporting — format de reporting réglementaire unifié pour les établissements de crédit européens, transmis à la BCE.", source: "EBA",        phase_intro: 1, certified: true,  owner: "Conformité",           bcbs: true  },
  { id: "g08", terme: "P&L",            domaine: "Finance",     definition: "Profit and Loss — compte de résultat mesurant la performance financière d'une entité sur une période donnée.", source: "IFRS",       phase_intro: 1, certified: true,  owner: "Direction Finance",    bcbs: false },
  { id: "g09", terme: "Data Owner",     domaine: "Gouvernance", definition: "Responsable métier d'un domaine de données, garant de sa définition, qualité et conformité d'usage.", source: "DAMA-DMBOK", phase_intro: 2, certified: true,  owner: "CDO",                  bcbs: false },
  { id: "g10", terme: "Drift",          domaine: "IA",          definition: "Dégradation progressive des performances d'un modèle IA due à l'évolution des distributions des données en production.", source: "MLOps",      phase_intro: 3, certified: true,  owner: "Data Science",         bcbs: false },
  ...
  { id: "g13", terme: "EU AI Act",      domaine: "IA",          definition: "Règlement européen 2024/1689 encadrant le développement et déploiement des systèmes IA selon leur niveau de risque.", source: "UE",         phase_intro: 3, certified: true,  owner: "Conformité",           bcbs: false },
  { id: "g14", terme: "MDM",            domaine: "Données",     definition: "Master Data Management — gestion centralisée des données de référence pour garantir une version unique et cohérente.", source: "DAMA",       phase_intro: 4, certified: true,  owner: "Data Owner Clients",   bcbs: false },
  { id: "g15", terme: "Data Catalog",   domaine: "Gouvernance", definition: "Référentiel centralisé des métadonnées : définitions, propriétaires, qualité, lineage et règles de gestion des données.", source: "DAMA",       phase_intro: 3, certified: true,  owner: "CDO",                  bcbs: false },
  { id: "g16", terme: "BCBS 239",       domaine: "Conformité",  definition: "Principes du Comité de Bâle pour une agrégation efficace des données de risque et un reporting de risque fiable.", source: "BIS",        phase_intro: 1, certified: true,  owner: "Conformité",           bcbs: true  },
  { id: "g17", terme: "Exactitude",     domaine: "Qualité",     definition: "Dimension qualité mesurant la conformité des données à leur valeur réelle ou à une source de référence certifiée.", source: "DAMA",       phase_intro: 2, certified: true,  owner: "Data Steward Qualité", bcbs: true  },
  { id: "g18", terme: "Scoring Crédit", domaine: "Risques",     definition: "Probabilité de défaut d'un client calculée par un modèle IA à partir de données comportementales et financières.", source: "Interne",    phase_intro: 1, certified: false, owner: "Direction Risques",    bcbs: false },
];
...
const DATASETS = [
  ...
  { id: "d02", nom: "dim_clients_golden",     domaine: "MDM",           schema: "gold",   lignes: "3.1M",   fraicheur: "J-1",    qualite: 91, phase_intro: 4, owner: "Data Owner Clients",critical: true,  desc: "Golden record clients unifié — déduplication Core Banking + CRM + Risques via Semarchy." },
  ...
  { id: "d04", nom: "fact_gl_entries",        domaine: "Finance",       schema: "gold",   lignes: "12.4M",  fraicheur: "J-1",    qualite: 96, phase_intro: 2, owner: "Finance",           critical: true,  desc: "Écritures du Grand Livre SAP — P&L, bilan, charges et produits par centre de coût." },
  { id: "d05", nom: "stg_core_banking_raw",   domaine: "Core Banking",  schema: "silver", lignes: "180.2M", fraicheur: "J",      qualite: 71, phase_intro: 1, owner: "IT/DSI",            critical: false, desc: "Données brutes extraites de Temenos T24 — zone staging avant transformation dbt." },
  { id: "d06", nom: "mart_bcbs_reporting",    domaine: "Conformité",    schema: "gold",   lignes: "240K",   fraicheur: "J-1",    qualite: 92, phase_intro: 3, owner: "Conformité",        critical: true,  desc: "Data mart dédié aux reportings BCBS 239 — 14 données critiques agrégées et certifiées." },
  ...
  { id: "d08", nom: "fact_market_data",       domaine: "Trésorerie",    schema: "silver", lignes: "22.1M",  fraicheur: "Temps réel", qualite: 99, phase_intro: 2, owner: "Trésorerie",   critical: true,  desc: "Données marché Bloomberg — cours, taux, spreads de crédit, volatilités." },
  ...
  { id: "d10", nom: "mart_customer_360",      domaine: "Clients",       schema: "gold",   lignes: "3.1M",   fraicheur: "J-1",    qualite: 86, phase_intro: 4, owner: "Marketing",         critical: false, desc: "Vue 360° client — transactions, produits détenus, interactions, score de risque." },
  { id: "d11", nom: "stg_murex_risk_raw",     domaine: "Risques",       schema: "silver", lignes: "4.2M",   fraicheur: "J",      qualite: 82, phase_intro: 1, owner: "IT/DSI",            critical: true,  desc: "Données brutes Murex — positions de trading, sensibilités, données de marché." },
  { id: "d12", nom: "fact_fraud_signals",     domaine: "Conformité",    schema: "gold",   lignes: "890K",   fraicheur: "Temps réel", qualite: 93, phase_intro: 3, owner: "Conformité",   critical: false, desc: "Signaux de fraude détectés par le modèle FraudDetector — transactions scorées." },
];
